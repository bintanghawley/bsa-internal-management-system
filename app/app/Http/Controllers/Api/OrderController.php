...
class OrderController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        ActivityLogger::log('Tambah Data: Pesanan dari ' . $order->author_name, 'Pesanan', 'sukses', null, ['id' => $order->id]);
    ...
    public function update(Request $request, Order $order): JsonResponse
    {
        ...
        ActivityLogger::log('Edit Data: Pesanan dari ' . $order->author_name, 'Pesanan', 'sukses', null, ['id' => $order->id]);
    ...
    public function destroy(Order $order): JsonResponse
    {
        ...
        ActivityLogger::log('Hapus Data: Pesanan dari ' . $order->author_name, 'Pesanan', 'warning', null, ['id' => $id]);
