...
class ActivityLogController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        ActivityLogger::log('Tambah Data: Catatan manual', 'Aktifitas', 'sukses', null, ['id' => $log->id]);
    ...
    public function update(Request $request, ActivityLog $activityLog): JsonResponse
    {
        ...
        ActivityLogger::log('Edit Data: Catatan manual', 'Aktifitas', 'warning', null, ['id' => $activityLog->id]);
    ...
    public function destroy(ActivityLog $activityLog): JsonResponse
    {
        ...
        ActivityLogger::log('Hapus Data: Catatan manual', 'Aktifitas', 'warning', null, ['id' => $id]);
