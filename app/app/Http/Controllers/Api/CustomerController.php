...
class CustomerController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        ActivityLogger::log('Tambah Data: Pelanggan ' . $customer->name, 'Pelanggan', 'sukses', null, ['id' => $customer->id]);
    ...
    public function update(Request $request, Customer $customer): JsonResponse
    {
        ...
        ActivityLogger::log('Edit Data: Pelanggan ' . $customer->name, 'Pelanggan', 'sukses', null, ['id' => $customer->id]);
    ...
    public function destroy(Customer $customer): JsonResponse
    {
        ...
        ActivityLogger::log('Hapus Data: Pelanggan ' . $customer->name, 'Pelanggan', 'warning', null, ['id' => $id]);
