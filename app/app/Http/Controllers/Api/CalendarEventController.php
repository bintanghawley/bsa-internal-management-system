...
class CalendarEventController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        ActivityLogger::log('Tambah Data: Agenda ' . $event->title, 'Kalender', 'sukses', null, ['id' => $event->id]);
    ...
    public function update(Request $request, CalendarEvent $calendarEvent): JsonResponse
    {
        ...
        ActivityLogger::log('Edit Data: Agenda ' . $calendarEvent->title, 'Kalender', 'sukses', null, ['id' => $calendarEvent->id]);
    ...
    public function destroy(CalendarEvent $calendarEvent): JsonResponse
    {
        ...
        ActivityLogger::log('Hapus Data: Agenda ' . $calendarEvent->title, 'Kalender', 'warning', null, ['id' => $id]);
