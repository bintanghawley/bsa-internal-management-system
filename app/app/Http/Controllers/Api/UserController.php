...
class UserController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        ActivityLogger::log('Tambah Data: Karyawan ' . $user->name, 'Karyawan', 'sukses', null, ['id' => $user->id]);
    ...
    public function update(Request $request, User $user): JsonResponse
    {
        ...
        ActivityLogger::log('Edit Data: Karyawan ' . $user->name, 'Karyawan', 'sukses', null, ['id' => $user->id]);
    ...
    public function destroy(User $user): JsonResponse
    {
        ...
        ActivityLogger::log('Hapus Data: Karyawan ' . $user->name, 'Karyawan', 'warning', null, ['id' => $id]);
