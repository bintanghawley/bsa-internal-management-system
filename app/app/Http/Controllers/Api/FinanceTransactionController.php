...
class FinanceTransactionController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        ActivityLogger::log('Tambah Data: Transaksi Rp ' . number_format($transaction->amount, 0, ',', '.'), 'Keuangan', 'sukses', null, ['id' => $transaction->id]);
    ...
    public function update(Request $request, FinanceTransaction $financeTransaction): JsonResponse
    {
        ...
        ActivityLogger::log('Edit Data: Transaksi Rp ' . number_format($financeTransaction->amount, 0, ',', '.'), 'Keuangan', 'sukses', null, ['id' => $financeTransaction->id]);
    ...
    public function destroy(FinanceTransaction $financeTransaction): JsonResponse
    {
        ...
        ActivityLogger::log('Hapus Data: Transaksi Keuangan', 'Keuangan', 'warning', null, ['id' => $id]);
