...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ActivityLog>|ActivityLog whereLoggedAt($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<CalendarEvent>|CalendarEvent whereEventTime($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<CalendarEvent>|CalendarEvent whereLocation($value)
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property float $total_spending
     * @property int $order_history_count
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Customer>|Customer whereOrderHistoryCount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Customer>|Customer whereTotalSpending($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereTransactionDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereCategory($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereAmount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereOrderId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction whereCost($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<FinanceTransaction>|FinanceTransaction timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class FinanceTransaction extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property-read \App\Models\FinanceTransaction $financeTransaction
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereAuthorName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereProductName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereNominal($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<OrderItem>|OrderItem whereBuyPrice($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product wherePriceBuy($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product wherePriceSell($value)
     ...
     * @property string $title
     * @property \Illuminate\Support\Carbon $report_month
     * @property int $id
     * @property-read \App\Models\User $generatedBy
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report whereReportMonth($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report whereGeneratedByUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report whereTotalRevenue($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report whereTotalOrders($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report whereTotalCustomers($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report whereNotes($value)
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Report> $generatedReports
